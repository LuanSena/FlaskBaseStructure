...
class CGIRootFix(object):
    ...
    and you have problems with your api root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your api is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your api, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the api.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        api = HeaderRewriterFix(api, remove_headers=['Date'],
