...
class Api(object):
    ...
    :param catch_all_404s: Use :meth:`handle_error`
        to handle 404 errors throughout your api
    ...
    :param url_part_order: A string that controls the order that the pieces
        ...
        is the blueprint (or blueprint registration) prefix, 'a' is the resources
    ...
    def init_app(self, app):
        ...
        """
        # If api is a blueprint, defer the initialization
        try:
    ...
    def _deferred_blueprint_init(self, setup_state):
        """Synchronize prefix between blueprint/resources and registration options, then
        perform initialization with setup_state.api :class:`flask.Flask` object.
    ...
    def error_router(self, original_handler, e):
        ...
        api's original error handler will be dispatched.
        In the event that the error occurred in a flask-restful endpoint but
        the local handler can't resolve the situation, the router will fall
        back onto the original_handler as last resort.

        :param original_handler: the original Flask error handler for the api
    ...
    def add_resource(self, resource, *urls, **kwargs):
        ...
        Examples::
            ...
            resources.add_resource(HelloWorld, '/', '/hello')
            resources.add_resource(Foo, '/foo', endpoint="foo")
            resources.add_resource(FooSpecial, '/special/foo', endpoint="foo")
    ...
    def resource(self, *urls, **kwargs):
        ...
        resources. Parameters are the same as :meth:`~flask_restful.Api.add_resource`.
    ...
    def representation(self, mediatype):
        ...
        resources. Transformers are functions that must be decorated with this
        ...
        * A dictionary of headers
        ...
        Ex::
            ...
            @resources.representation('application/xml')
